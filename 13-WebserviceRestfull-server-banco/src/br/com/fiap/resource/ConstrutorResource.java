...
@Path("/consultor")
public class ConstrutorResource {
//GET POST PUT DELETE
	...
	public Response cadastrar(Consultor consultor, @Context UriInfo uriInfo){
	...
	@Path("/{id}")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response atualizar(Consultor consultor, @PathParam("id")int codigo){
